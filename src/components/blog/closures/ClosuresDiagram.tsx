  ...
  return (
    <div className="my-6">
      ...
      >
        ...
        <desc>
          Left: JS source code with scope-colored line highlights. Right: nested
          scope diagram showing which variables live where.
        </desc>
        <defs>
          <marker
            id="closureArrow"
