  ...
  return (
    <div ref={ref} className="not-prose my-8 overflow-x-auto">
      ...
      >
        ...
        <desc>
          Comparison of three binary tree traversal methods with animated
        ...
        <path
          className="tto-a d2"
          d="M105,73 Q88,93 80,111"
          fill="none"
          stroke="rgb(127,119,221)"
          strokeWidth="1.4"
          markerEnd="url(#tto-arrow)"
        />
        ...
        <path
          className="tto-a d4"
          d="M600,111 Q588,90 577,76"
          fill="none"
          stroke="rgb(216,90,48)"
          strokeWidth="1.4"
          markerEnd="url(#tto-arrow)"
        />
        ...
        <text
          ...
          fontFamily="-apple-system,system-ui,sans-serif"
        >
          Traversal order comparison on the same tree
        </text>
        ...
        <text
          ...
          fontFamily="-apple-system,system-ui,sans-serif"
        >
          Memory free / dependency resolve
        </text>
      </svg>
